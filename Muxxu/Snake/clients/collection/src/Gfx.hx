...
class GfxCollection extends BitmapData { }
...
class Gfx {//}
	...
	static public var collection :		pix.Store;
	...
	static public function init() {
		...
		// COLLECTION
		var bmp = new GfxCollection(0, 0);
		makeTransp(bmp, WHITE);
		collection = new pix.Store(bmp);
		collection.addIndex("section_bg");
		collection.slice(0, 0, 70, 70);
		collection.addIndex("section_bg_small");
		collection.slice(145, 0, 52, 52);
		
		collection.addIndex("section_icons");
		collection.slice(70, 0, 43, 36);
		collection.slice(113, 0, 32, 36);
		collection.slice(70, 36, 44, 22);
		collection.slice(0, 0, 39, 30);
		collection.addIndex("ticket");
		collection.slice(70, 58, 12, 8);
		collection.addIndex("perso");
		collection.slice(0, 70, 104, 125);
		collection.slice(104, 70, 108, 125);
		collection.slice(212, 70, 99, 125);
		collection.addIndex("arrow");
		collection.slice(82, 58, 12, 12);
	...
	static public function col(key, inc = 0) {
		if( inc == 0 ) return pal.get(key);
		return Col.brighten(pal.get(key), inc);
	}

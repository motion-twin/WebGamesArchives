...
@:autoBuild(r3d.VBMacro.build()) extern class MemoryObject extends AbstractBuffer {
}

@:autoBuild(r3d.VBMacro.buildBuffer()) extern class ObjectBuffer<T> extends AbstractBuffer {
}
...
class VBMacro {
	...
	public static function buildBuffer() {
		...
		var tmanager = TPath( { name : "VirtualBuffer", pack : [], params : [], sub : "VirtualManager" } );

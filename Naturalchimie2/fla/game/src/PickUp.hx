...
class PickUp {
	...
	var objectList  : Array<{id : _ArtefactId, t : Float, q : Int}> ;
	...
	public function addParts(a : Array<Phys>, aid : _ArtefactId, t : Float, ?q : Int) {		
		for (p in a) {
...
class OmcPhys extends Phys { //dispose bmp on phys kill
	...
	override public function kill() {
		if (omc != null && omc.mc != null && omc.mc._b._m._p != null)
			omc.mc._b._m._p.dispose() ;
	...
	public override function update(){
		...
		if (sleep == null && oldSleep != null)
			Game.me.sound.play("wombat_dent2") ;
	}

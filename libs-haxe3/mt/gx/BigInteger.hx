...
//ref : http://grepcode.com/file_/repository.grepcode.com/java/root/jdk/openjdk/6-b14/java/math/BigInteger.java/?v=source
typedef Bytes = Int;
...
private class Character {
	public static inline var MIN_RADIX = 2;
	public static inline var MAX_RADIX = 36;
}
...
class BigInteger{
     ...
     */
    var firstNonzeroIntNum = -2;

    /**
     * This mask is used to obtain the value of an int as if it were unsigned.
     */
	public static inline var LONG_MASK = 0xffffffff;
     ...
     * @see    Character#digit
     */
    public function new(val:String, radix:Int = 10) {
        ...
        var numBits = Std.int(((numDigits * bitsPerDigit[radix]) >>> 10) + 1);
        var numWords = (numBits + 31) /32;
        mag = [];
        ...
        var group = val.substr(cursor, cursor += firstGroupLen);
    ...
    private static function destructiveMulAdd( x:Array<Int>, y:Int, z:Int) {
        // Perform the multiplication word by word
        var ylong : haxe.Int64 = Int64.ofInt(y & LONG_MASK);
        var zlong : haxe.Int64 = Int64.ofInt(z & LONG_MASK);
		
        var len = x.length;

        var product : haxe.Int64 = Int64.ofInt(0);
        var carry : haxe.Int64 = Int64.ofInt(0);
        for (int i = len-1; i >= 0; i--) {
            product = Int64.add(Int64.mul(ylong , (x[i] & LONG_MASK)) , carry);
            x[i] = Std.int(product);
            carry = Int64.shl(product, 32);
        }

        // Perform the addition
        long sum = (x[len-1] & LONG_MASK) + zlong;
        x[len-1] = (int)sum;
        carry = Int64.shl(sum , 32);

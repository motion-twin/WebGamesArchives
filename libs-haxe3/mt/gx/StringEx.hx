...
class StringEx
{
	...
	public static function firstBlankIndex(str:String) : Int
	{
		for( k in 0...str.length)
			if( isBlank(str.charAt( k ) ))
				return k;
		return -1 ;
	}
	...
	public static function parseWord( r:String , w:String) 
	{
		r = r.trim();
		if ( r.startsWith( w ))
			return r.substr( w.length );
		else return null;
	}
	...
	public static inline function replace(str:String, pat:String,sub:String)
	{

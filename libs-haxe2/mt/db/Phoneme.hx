...
class Phoneme {
	...
	public static function removeAccentsUTF8( s : String ) {
		#if neko
		var b = new haxe.Utf8(s.length);
		...
		#end
			switch( c ) {
			case "é".code, "è".code, "ê".code, "ë".code: b.addChar("e".code);
			case "É".code, "È".code, "Ê".code, "Ë".code: b.addChar("E".code);
			case "à".code, "â".code, "ä".code, "á".code: b.addChar("a".code);
			case "À".code, "Â".code, "Ä".code, "Á".code: b.addChar("A".code);
			case "ù".code, "û".code, "ü".code, "ú".code: b.addChar("u".code);
			case "Ù".code, "Û".code, "Ü".code, "Ú".code: b.addChar("U".code);
			case "î".code, "ï".code, "í".code: b.addChar("i".code);
			case "Î".code, "Ï".code, "Í".code: b.addChar("I".code);
			case "ô".code, "ó".code, "ö".code, "õ".code: b.addChar("o".code);
			case "Ô".code, "Ó".code, "Ö".code: b.addChar("O".code);

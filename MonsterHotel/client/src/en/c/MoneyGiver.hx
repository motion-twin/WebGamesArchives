...
class MoneyGiver extends en.Client {
	var tang			: Float;
	...
	public function new(cid:Int, ?r) {
		...
		spr.a.registerStateAnim("monsterWeekEnderIdle", 0);
	...
	override function initSprite() {
		spr = new mt.deepnight.slb.HSpriteBE(game.monstersSb1, Assets.monsters1, "monsterWeekEnderIdle");
	}

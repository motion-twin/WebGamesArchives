...
class GridTools
{
	...
	public static function getAllNeighbours<T>( grid:Grid<T>, x:Int, y:Int ) : {left:Null<T>, right:Null<T>, top:Null<T>, bottom:Null<T>, topLeft:Null<T>, topRight:Null<T>, bottomLeft:Null<T>, bottomRight:Null<T>}
	{
	...
	public static function getNeighbours<T>( grid:Grid<T>, x:Int, y:Int ) : {left:Null<T>, right:Null<T>, top:Null<T>, bottom:Null<T>}
	{
		return {

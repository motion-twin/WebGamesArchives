class sb.Square extends ScrollBar{//}
	...
	function init(){
		...
		if(this.marginInside==undefined)this.marginInside = 1;
	...
	function drawSquare(){
		this.square.clear();
		var pos = {x:0,y:0};
		pos[fir] = this.marginInside
		pos[this.firSize] = this.size - this.marginInside*2;
		pos[this.dirSize] = this.squareLong;
		//var style = this.win.style.global
		FEMC.drawSquare(this.square,pos,this.color.fore.main)
		//_root.test+="this.color.fore("+this.color+")\n"
	}
	...
	function buildScrollBar(){
		...
		FEMC.drawSquare(this.fond,pos,this.color.back.shade);

// 
// $Id: Renfort.as,v 1.1 2004/02/10 18:27:30  Exp $
//
...
class frutibandas.gui.options.Renfort implements Animable
{
    private static var ANIM_LENGTH =  10;
    ...
    public function Renfort( s:Sprite, c:Coordinate, newTeam:Number )
    {
        this.sprite = s;

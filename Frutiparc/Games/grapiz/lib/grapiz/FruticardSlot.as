// 
// $Id: FruticardSlot.as,v 1.4 2004/05/06 11:10:53  Exp $
//

import frusion.client.FrusionClient;
import grapiz.Main;

class grapiz.FruticardSlot 
{
    ...
    public var $linit : Boolean; // set to true when league score is initialized
    ...
    private function increment( mode:Number, index:Number ) : Void
    {
        switch (mode) {
            ...
            case 1:
                return; // challenge does not save its values to the fruticard anymore
                // $c[index]++;
                // break;
